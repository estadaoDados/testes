...
#Gerando um dicionário no qual as chaves são os partidos e os valores são todos os dados referentes ao partido
for linha in reader:
    dados_parciais[linha['nome_partido']] = linha

#Gerando um dicionário apenas com os dados absolutos
